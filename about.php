<?php include("header.php"); ?>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      <img src="assets/img/sdmcujire.jpg" alt="Hero Imgs" data-aos="zoom-out" data-aos-delay="100" width="500%">
    </div>
